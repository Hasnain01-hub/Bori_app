...
class MainActivityBookingList extends StatefulWidget {
  @override
  _BottomBarState createState() => new _BottomBarState();
}

class _BottomBarState extends State<MainActivityBookingList> {
  late int _pageIndex = 0;
  late PageController _pageController;

  List<Widget> tabPages = [BookingListScreen(), MiddleScreen(), AboutScreen()];
