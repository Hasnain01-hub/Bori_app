...
class MainActivityContact extends StatefulWidget {
  @override
  _BottomBarState createState() => new _BottomBarState();
}

class _BottomBarState extends State<MainActivityContact> {
  late int _pageIndex = 2;
  late PageController _pageController;

  List<Widget> tabPages = [HomeScreen(), MiddleScreen(), ContactScreen()];
