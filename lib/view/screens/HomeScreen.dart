    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: AppTheme.AppBarTheme,
          title: Text('Bhandarkar Oriental Research Institute',style: TextStyle(color: AppTheme.appbar_title,fontSize: 17,fontWeight: FontWeight.w600),),
      ...
      body: Container(
            ...
            Container
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Search',
                  hintStyle: TextStyle(color:AppTheme.AppBarTheme,fontWeight: FontWeight.normal,fontSize: 14,),
          ...
          child:Container(
           ...
           child:Column(
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _currentIndex == index
                    ? Color.fromRGBO(100, 41, 8, 0.8)
                    : Color.fromRGBO(243, 204, 158, 0.3),
              ),
            );
                  }).toList(),
                ),
            ...
            builder: (context) => MainActivityMahabharata()));
            ...
            onTap: () {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('Admission',style:TextStyle(fontSize: 13.0,
                      color: AppTheme.AppBarTheme,
            ...
            child: Material(
              color: AppTheme.more_bg,
               child: InkWell(
                 onTap: () {
                   Navigator.of(context).push(MaterialPageRoute(
                       builder: (context) => MainActivityLibrary()));
              ...
              Padding(
                  ...
                  Text('Library',style:TextStyle(fontSize: 13.0,
              color: AppTheme.AppBarTheme,
              fontWeight: FontWeight.w900),),
                ],
              ),),
            ...
            Expanded(
              ...
              onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => MainActivityBookingList()));
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text('Booking',style:TextStyle(fontSize: 13.0,
                      color: AppTheme.AppBarTheme,
                      fontWeight: FontWeight.w900),),
                ],
              ),
            ...
            Container(
              width: double.infinity,
              margin: EdgeInsets.only(left: 10.0, right: 10.0, top: 20.0,bottom: 5),
