...
class MainActivityBookingDetails extends StatefulWidget {
  // const MainActivityBookingDetails({Key? key, required this.t}) : super(key: key);
  // final String t;
...
class _BottomBarState extends State<MainActivityBookingDetails> {
