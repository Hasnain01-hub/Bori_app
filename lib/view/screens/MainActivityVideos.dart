...
class MainActivityVideos extends StatefulWidget {
  @override
  _BottomBarState createState() => new _BottomBarState();
}

class _BottomBarState extends State<MainActivityVideos> {
  late int _pageIndex = 2;
  late PageController _pageController;

  List<Widget> tabPages = [HomeScreen(), MiddleScreen(), VideoListScreen()];
