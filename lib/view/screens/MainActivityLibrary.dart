...
class MainActivityLibrary extends StatefulWidget {
  @override
  _BottomBarState createState() => new _BottomBarState();
}

class _BottomBarState extends State<MainActivityLibrary> {
  late int _pageIndex = 0;
  late PageController _pageController;

  List<Widget> tabPages = [LibraryScreen(), MiddleScreen(), AboutScreen()];
